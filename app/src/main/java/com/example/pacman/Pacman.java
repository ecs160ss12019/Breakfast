...
//        setCenter(x, y);
    ...
    //Constructor2
    public Pacman(Context context, int sx, int sy, Arcade arcade, TwoTuple posInArcade,
    ...
    //Constructor
    public Pacman(Context context, int sx, int sy, TwoTuple posInArcade, Pair<Integer, Integer> optimalSize,
